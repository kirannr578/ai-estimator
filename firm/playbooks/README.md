...
| [`private-gc-sub-bid.md`](private-gc-sub-bid.md) | **BPC as sub** to a private General Contractor (regional / national private GC; restaurant + retail + hotel rollouts; private K-12 / higher-ed; CM-at-risk on a public-funded project where BPC sub-quotes to the CM) — different rules, different docs, different risks than prime-to-public pursuits | [`bids/_WATCHLIST/longhorn-little-elm-bcibelisle.md`](../../bids/_WATCHLIST/longhorn-little-elm-bcibelisle.md) (live watchlist; GC-Belisle / Longhorn Little Elm); [`bids/mcc-cosmetology-phase4-2026-0622/`](../../bids/mcc-cosmetology-phase4-2026-0622/) (HCS Inc., public-pass-through CM-at-risk); [`bids/7eleven-celina-2026-0605/`](../../bids/7eleven-celina-2026-0605/) (Ready Construction, pure-private); [`bids/tmd-camp-maxey-roof-2026-0626/`](../../bids/tmd-camp-maxey-roof-2026-0626/) (Adam's Trade & Services, public-pass-through) |
...
| **Private GC sub-bid** (BPC as sub to a private GC; restaurant + retail + hotel rollouts; private K-12 / higher-ed; CM-at-risk on a public-funded project) | [private-gc-sub-bid](private-gc-sub-bid.md) | GC-Belisle / Longhorn Little Elm (watchlist); HCS Inc. / McLennan Phase 4 CSC; Ready Construction / 7-Eleven Celina; Adam's Trade & Services / Camp Maxey Roof | GC portals (BuildingConnected, BuildBid, Procore Bid Board, PlanGrid, iSqFt, DemandStar, HCS Box, GC's own password-protected portal); email-attached ZIP | Current COI (GC + owner as AI via **CG 20 10** + **CG 20 37**; **primary-and-non-contributory**; waiver of subrogation); W-9; diversity certs (door-openers via DFWMSDC channel); OSHA 10/30 roster; bondability letter (only if sub P&P requested) | Rare at sub tier (under $1M); GC-discretion when requested | Rare at sub tier (under $1M); GC may require on MEP / structural-steel packages | NAICS 236220 / 238 trades; restaurant + retail fit-out, C-store ground-up, hotel-brand fit-out, private institutional renovation, sub-tier scope on CM-at-risk public-funded jobs |
| **Private commercial / institutional negotiated — BPC as prime** | *not playbook-grade; ad-hoc* | Hindu Temple of Southlake; Holiday Inn (Hall Park); Lavon RV Park | Owner-direct, GC partner | COI, W-9, bond letter (if requested) | Owner-discretion | Owner-discretion | Varies |
