...
> **STATUS: FORMULAS REFINED 2026-05-23 against the actual downloaded CSP package** (drawings A0.1–E1.2 + Project Manual). Quantities still `[USER TO FILL]` after Bluebeam takeoff against A2.1 / P1.1 / M1.1 / E1.2.
...
>
> **Pricing form structure:** Single CSI-division line-item sheet inside `Harrington_Lab303_Specifications.pdf` (Section 00 42 13 Proposal Form). Bidder fills:
...
| 06 | Lab Casework per A2.1/A2.2 + H2I Sub-06 (carry $20K–$60K allowance pending H2I retrieval) | `$[USER TO FILL]` |
...
| 27 | Communications / low-voltage pathway (TAMU TS pulls cable) | `$[USER TO FILL]` |
