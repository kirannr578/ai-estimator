...
>
> 3. **Construction documents.** We would like to confirm we have the most current version of the construction documents — architectural and MEP drawings, full project manual / specifications, finish + door schedules. Could you point us to the portal location where these are downloadable, or send direct file links if convenient?
>
> 4. **Owner-furnished scope demarcation.** The RFCSP narrative identifies technology, network cabling, equipment install, furniture, and fire suppression as owner-furnished. Would you be able to confirm in writing that we should NOT price (a) sprinkler-head relocation or any FP system modifications, (b) AV / data cabling pulls and terminations, (c) CBORD access-control devices themselves, (d) furniture / FF&E / lockers / costume storage? We will price coordination, protection, and rough-ins for these items as required, but want to avoid double-pricing or under-pricing the contract.
>
> 5. **CBORD coordination POC.** Could you put us in touch with the CBORD system administrator at ASU so we can align on device rough-in standards (back-box, conduit, power) for the door-hardware sub at sub-quote time?
>
> 6. **HSP delivery.** The HSP is due Monday 6/8 at 5:00 PM CST. Could you confirm the HSP delivery location — same as the proposal (FP&C) or separate (TTUS HUB Operations)?
>
> 7. **Pre-existing hazmat survey.** Carr EFA appears to be older construction. Has ASU EHS conducted a hazardous-materials survey of the dressing-room area that we could review? This would help us scope abatement allowance accurately.
>
> Thank you in advance — happy to discuss any of this by phone if easier.
>
> Best regards,
...
> Subject: Subcontractor Bid Invitation — Carr EFA Dressing Room Renovation, ASU (Sol 26-007), [trade] — Bids Due 5/29
>
> [Sub name],
>
...
> - Location: ASU Station #10924, San Angelo, TX 76909
> - Construction window: 7/1/2026 NTP → 11/2/2026 substantial completion (~4 months)
> - Owner: Angelo State University / Texas Tech University System
> - Tom Green County prevailing wage applies
>
> **Scope summary for [trade]:**
> [Lift from `04-scope-of-work.md` § C, trade-specific row]
>
> **What we need from you:**
> - Lump-sum bid for the [trade] scope, broken out by major scope element
> - Schedule of values
> - Confirmation of bonding capacity and insurance compliance with TTUS UGSC Article 5 limits (GL $1M/$2M, Auto $1M, WC statutory, Umbrella $5M)
> - Current HUB certification number + expiration date
> - Your standard W-9
>
> **Bid due to us:** [DATE] 2026-05-29, 5:00 PM CST
>
> **Drawings:** Attached to this email (or available at [LINK to portal]) — if drawings haven't been issued by us yet, please respond with your willingness to bid and we will send drawings as soon as they are received from the owner.
>
> Questions? [USER TO FILL: bid-prep lead name] at [phone] or [email].
>
> Best regards,
> [name]
> Blue Print Constructs
...
> Subject: Bond capacity reservation — Carr EFA Dressing Room Renovation (ASU Sol 26-007)
>
> [Bonding agent name],
>
> Please reserve bond capacity for the following upcoming bid:
>
> - Project: Carr EFA Dressing Room Renovation, Angelo State University
> - Solicitation: 26-007 (TTUS member institution)
> - Bid envelope: ~$485K (range $425K–$560K)
> - Bid due: 6/5/2026, 2:00 PM CST
> - Bid bond: 5% of base proposal on TTUS-required form
> - Payment Bond + Performance Bond commitment letters required at proposal (100% of contract value, due at award)
> - Surety must be A.M. Best A- or better and on US Treasury Circular 570 list
> - Bond payable to: "The Board of Regents of the Texas Tech University System"
>
> Please confirm:
> 1. Capacity is reserved against this envelope
> 2. TTUS-required bond form is in your library (or, if not, you can produce on the TTUS standard form within 3 business days of getting the form)
> 3. Expected lead time once we provide the final bid amount on 6/3/2026
>
> Final bid amount confirmation: 6/3/2026 COB
> Bid bond delivery to firm: 6/4/2026 COB (so we can attach to proposal package on 6/5)
>
> Thank you,
> [USER TO FILL: bid-prep lead name]
...
`[USER TO FILL]` — list the firm's:
- Bid-prep lead
- Estimator
- Project manager-of-record (committed for the 2026-07-01 → 2026-11-02 window)
- Superintendent
- Safety lead
- HSP / HUB compliance lead (could be same person as bid-prep lead)
- Insurance broker (to confirm UGSC Art. 5 limits)
- Bonding agent
- Accounting (for TX sales tax exemption setup)
