...
# across three extractors (door, panel, lighting) — and four with the
# T2.8 HVAC slice.  Imported under the legacy underscore-prefixed name
# to keep this module's internal call-sites unchanged from their T2.7
# shape.
